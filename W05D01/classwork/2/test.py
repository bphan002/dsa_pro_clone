...
class TestExample(unittest.TestCase):
    ...
    def run_test(self, input_values, expected_value):
        solution = Solution()
        output = removeElements(solution, *input_values)
    ...
    def test_case_1(self):
        print('Test Case 1:')
        self.run_test([create_linked_list([1,2,6,3,4,5,6]), 6], create_linked_list([1,2,3,4,5]))
    
    @timeout(2)
    def test_case_2(self):
        print('Test Case 2:')
        self.run_test([create_linked_list([]),1], create_linked_list([]))

    @timeout(2)
    def test_case_3(self):
        print('Test Case 3:')
        self.run_test([create_linked_list([7,7,7,7]),7], create_linked_list([]))
        
    @timeout(2)
    def test_case_4(self):
        self.run_test([create_linked_list([26, 32, 84, 91, 15, 73, 26, 68, 49, 26]),26], create_linked_list([32, 84, 91, 15, 73, 68, 49]))
